...
namespace Domari
{
    public class Soba
    {
        ...
        {
            if (noviBroj >= 100 && noviBroj < 200)
            {
                kapacitet = 2;
                brojSobe = noviBroj;
            }
            else if (noviBroj >= 200 && noviBroj < 300)
            {
                kapacitet = 3;
                brojSobe = noviBroj;                        //Medina Sirco
            }
            else if (noviBroj >= 300 && noviBroj < 400)
            {
                kapacitet = 4;
                brojSobe = noviBroj;
            }
            ...
            {
                throw new InvalidOperationException("Broj neispravan!");
            }
